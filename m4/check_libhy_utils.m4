...
dnl     00      zhenquan.qiu        18/08 2023      create the file
dnl 
dnl     last modified: 18/08 2023 09:11
dnl ===============================================================
        ...
        yes)
            ...
            case "$have_hy_utils" in
                ...
                *)
                    ...
                    # clear cache
                    unset ac_cv_search_HyUtilsCheck
                    AC_SEARCH_LIBS([HyUtilsCheck], [hy_utils],
                            [have_hy_utils=yes
                                HY_UTILS_LIBS="$LIBS"],
                            [have_hy_utils=no],
                            [])
            ...
            case "$have_hy_utils" in
                yes)
                    AC_CHECK_LIB([hy_utils], [HyMcuCheck])
                    AC_DEFINE(HAVE_HY_UTILS, 1, [Define if the system has hy_utils])
                ;;
                *)
                    AC_MSG_WARN([hy_utils is a must but can not be found. You should add the \
